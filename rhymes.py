"""
    ...
    Course: CSC 120-001 - Intro to Computer Programing II, Section 12, Fall 2022.
"""
...
def primary_stress_search (phonemes, word_analyzed):
    ...
    pre-condition: the parameters aforementioned are a dictionary and a word(string) respectively.
...
def linking_rhymes (main_dict, the_new_d):
    ...
    pre-condition: the parameters must be a dictionaries

    post-condition: a list returned
    """
...
def main():
    ...
    for i in rhymes: # rhymes is a list being indexed through
        print (i) # print each rhyming word line by line and alphabetically
